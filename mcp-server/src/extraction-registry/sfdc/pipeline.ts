...
const opportunitiesPath: ExtractionPath = {
  ...
  expectedFields: [
    ...
    },
    {
      ...
      type: 'string',
      sfdcName: 'Owner.Name',
      description: 'Opportunity owner display name',
    },
    {
      name: 'RecordTypeName',
      type: 'string',
      sfdcName: 'RecordType.Name',
      description: 'Record type (New Business, Renewal, Upsell, etc.)',
    },
    {
      name: 'StageName',
      type: 'string',
    ...
    },
    {
      ...
      type: 'amount',
      sfdcName: 'Amount',
      description: 'Opportunity amount in default currency',
    },
    {
      name: 'CloseDate',
      type: 'date',
    ...
    },
    {
      name: 'CreatedDate',
      type: 'date',
      sfdcName: 'CreatedDate',
      description: 'Record creation timestamp',
    },
    {
      name: 'LastModifiedDate',
      type: 'date',
      sfdcName: 'LastModifiedDate',
      description: 'Last modification timestamp',
    },
    {
      name: 'ForecastCategory',
      type: 'string',
      sfdcName: 'ForecastCategory',
      description: 'Forecast category (Pipeline, Best Case, Commit, Closed)',
    },
    {
      name: 'Probability',
      type: 'number',
      sfdcName: 'Probability',
...
const stageHistoryPath: ExtractionPath = {
  ...
  expectedFields: [
    ...
    },
    {
      ...
      type: 'string',
      sfdcName: 'StageName',
      description: 'Stage name at this snapshot',
    },
    {
      name: 'Amount',
      type: 'amount',
      sfdcName: 'Amount',
      description: 'Opportunity amount at this stage',
    },
    {
      name: 'Probability',
      type: 'number',
    ...
    },
    {
      ...
      type: 'amount',
      sfdcName: 'ExpectedRevenue',
      description: 'Amount * Probability at this stage',
    },
    {
      name: 'CloseDate',
      type: 'date',
      sfdcName: 'CloseDate',
      description: 'Expected close date at this stage',
    },
    {
      name: 'CreatedDate',
      type: 'date',
      sfdcName: 'CreatedDate',
      description: 'When this stage snapshot was created',
    },
    {
      name: 'CreatedById',
      type: 'string',
      sfdcName: 'CreatedById',
      description: 'User who triggered the stage change',
    },
    {
      name: 'ForecastCategory',
      type: 'string',
      sfdcName: 'ForecastCategory',
      description: 'Forecast category at this stage',
    },
    {
      name: 'SystemModstamp',
      type: 'date',
      sfdcName: 'SystemModstamp',
...
const activitiesPath: ExtractionPath = {
  ...
  expectedFields: [
    ...
    { name: 'Subject', type: 'string', sfdcName: 'Subject', description: 'Task subject line' },
    {
      name: 'ActivityDate',
      type: 'date',
      sfdcName: 'ActivityDate',
      description: 'Date the activity occurred or is due',
    },
    {
      name: 'Status',
      type: 'string',
      sfdcName: 'Status',
      description: 'Task status (Not Started, In Progress, Completed, etc.)',
    },
    {
      name: 'Priority',
      type: 'string',
    ...
    { name: 'OwnerId', type: 'string', sfdcName: 'OwnerId', description: 'Task owner user ID' },
    {
      ...
      type: 'string',
      sfdcName: 'Owner.Name',
      description: 'Task owner display name',
    },
    {
      name: 'CreatedDate',
      type: 'date',
    ...
    },
    {
      name: 'TaskSubtype',
      type: 'string',
      sfdcName: 'TaskSubtype',
      description: 'Task subtype (Task, Email, Call, etc.)',
    },
    {
      name: 'CallType',
      type: 'string',
    ...
    },
    {
      ...
      type: 'number',
      sfdcName: 'CallDurationInSeconds',
