...
const sapO2cOrderHeader: ExtractionPath = {
  ...
  expectedFields: [
    { name: 'VBELN', type: 'string', sapFieldName: 'VBELN', description: 'Sales document number' },
    {
      ...
      type: 'string',
      sapFieldName: 'AUART',
      description: 'Sales document type (e.g. OR=Standard Order)',
    },
...
const sapO2cOrderItems: ExtractionPath = {
  ...
  expectedFields: [
    ...
    { name: 'POSNR', type: 'string', sapFieldName: 'POSNR', description: 'Item number (6 chars)' },
    {
      ...
      type: 'string',
      sapFieldName: 'MATNR',
      description: 'Material number (18 chars)',
    },
    {
      name: 'ARKTX',
      type: 'string',
      sapFieldName: 'ARKTX',
      description: 'Item short text / description',
    },
    {
      name: 'KWMENG',
      type: 'number',
    ...
    { name: 'ROUTE', type: 'string', sapFieldName: 'ROUTE', description: 'Shipping route' },
    {
      ...
      type: 'string',
      sapFieldName: 'PSTYV',
      description: 'Item category (e.g. TAN=Standard)',
    },
  ],
  testData: {
    inputParams: { vbeln: '0000000001' },
...
const sapO2cDeliveryTiming: ExtractionPath = {
  ...
  expectedFields: [
    ...
    },
    {
      ...
      type: 'date',
      sapFieldName: 'ERDAT',
      description: 'Delivery created on date (from LIKP)',
    },
    ...
    },
    {
      ...
      type: 'string',
      sapFieldName: 'KUNNR',
      description: 'Ship-to party (customer number)',
    },
    ...
    { name: 'VRKME', type: 'string', sapFieldName: 'VRKME', description: 'Sales unit of measure' },
    {
      ...
      type: 'string',
      sapFieldName: 'VGBEL',
      description: 'Reference document (sales order number)',
    },
    {
      name: 'VGPOS',
      type: 'string',
      sapFieldName: 'VGPOS',
      description: 'Reference item (sales order item)',
    },
  ],
  testData: {
    inputParams: { vbeln: '0000000001' },
...
const sapO2cInvoiceTiming: ExtractionPath = {
  ...
  expectedFields: [
    ...
    { name: 'FKDAT', type: 'date', sapFieldName: 'FKDAT', description: 'Billing date' },
    {
      ...
      type: 'date',
      sapFieldName: 'ERDAT',
      description: 'Invoice created on date (from VBRK)',
    },
    { name: 'KUNAG', type: 'string', sapFieldName: 'KUNAG', description: 'Sold-to party' },
    {
      ...
      type: 'amount',
      sapFieldName: 'NETWR',
      description: 'Net value of the invoice',
    },
    { name: 'WAERK', type: 'string', sapFieldName: 'WAERK', description: 'Document currency' },
    { name: 'BUKRS', type: 'string', sapFieldName: 'BUKRS', description: 'Company code' },
    ...
    { name: 'FKIMG', type: 'number', sapFieldName: 'FKIMG', description: 'Billed quantity' },
    {
      ...
      type: 'amount',
      sapFieldName: 'NETWR',
      description: 'Net value of the invoice item',
    },
  ],
  testData: {
    inputParams: { vbeln: '0000000001' },
