...
<#
.SYNOPSIS
    Transaction Forensics - One-Click Installer for Windows

.DESCRIPTION
    This script provides an easy way to get started with Transaction Forensics on Windows.
...
$Script:RepoUrl = "https://github.com/chrbailey/SAP-Transaction-Forensics.git"
...
function Initialize-ProjectDirectory {
    ...
    if (Test-Path "docker-compose.yml") {
        ...
        if ($content -match "transaction-forensics") {
    ...
    if ($Directory) {
        ...
        # Default location
        $Script:ProjectDir = Join-Path $env:USERPROFILE "transaction-forensics"
        ...
        if (-not (Test-Path $Script:ProjectDir)) {
            if ($NonInteractive) {
                ...
                Write-Host ""
                Write-Host "Where would you like to install Transaction Forensics?"
                Write-Host ""
...
function Show-ModeMenu {
    Write-Host ""
    Write-Host "=== Transaction Forensics Setup Wizard ===" -ForegroundColor Cyan
    Write-Host ""
...
function New-EnvFile {
    ...
    # Generate main .env
    $envContent = @"
# Transaction Forensics Configuration
...
function Show-Summary {
    ...
    Write-Host ""
    Write-Host "Documentation: https://github.com/chrbailey/SAP-Transaction-Forensics" -ForegroundColor DarkGray
    Write-Host ""
}
...
function Main {
    ...
    Write-Step "Starting Transaction Forensics installation..."
    Write-Host ""
